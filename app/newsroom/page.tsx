...
export default async function Page() {
  ...
  return <>
    ...
    <section className="editorial-cta"><div className="container editorial-cta__inner"><div><span className="eyebrow">Press and media</span><h2>Looking for more information?</h2></div><a href="mailto:press@plekxa.com" className="button button-light">Contact our press team</a></div></section>
  </>;
}
